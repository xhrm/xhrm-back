...
trojango_link="https://github.com/p4gefau1t/trojan-go/releases/download/${latest_version}/trojan-go-linux-amd64.zip"
        ...
        ;;
      *)
        echo -e "${Error}不支持 [${bit}] ! 请向xhrm反馈[]中的名称，会及时添加支持。" && exit 1
        ;;
      esac
...
main() {
  echo -e "
${GREEN}===================================================
${GREEN}Trojan-go二合一脚本(authored by xhrm)
${GREEN}===================================================
${WHITE}如果已经安装了下列脚本之一，想要安装其他的，不需要单独执行卸载，直接选择想要安装脚本对应的数字即可……
${WHITE}因为安装的同时会执行卸载，除非想卸载干净回到初始状态,可以执行3……
${GREEN}===================================================
${WHITE}1. 安装trojan-go + nginx +tls
${GREEN}===================================================
${WHITE}2. 安装trojan-go + caddy +tls
${GREEN}===================================================
${WHITE}3. 卸载全部，系统回到初始状态
${GREEN}===================================================
${WHITE}4. 安装BBR加速
${GREEN}===================================================
${WHITE}0. 退出${NO_COLOR}"
